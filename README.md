...
| 황정수 | 메인페이지, 카테고리, 제품리스트, 키워드 검색, 회원가입/로그인  | B.E. |
| --- | --- | --- |
| 박진주 | 나의 서재, 뷰어 데이터 불러오기, 구매/결제하기 | B.E. |

</br>

| 윤선영 | 카테고리, 제품리스트, 상세페이지, 키워드검색 | F.E. |
| --- | --- | --- |
| 배효빈 | 나의 서재, 뷰어 기능, 구매/결제하기 | F.E. |
...
## 로그인/회원가입 
- 소셜로그인(카카오톡) api 이용한 로그인 기능 구현. 별도의 회원가입 없이 간단하게 카카오톡 계정을 이용해 로그인을 가능하도록 하여 
  user의 서비스 접근성 향상 
...
## 데모영상 
[링크](https://drive.google.com/file/d/1Ez78BKPQWy_w32n4FiB8bi8l6te_rLIA/view)
